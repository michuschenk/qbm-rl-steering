...
if __name__ == "__main__":
    ...
    agent = DQN('MlpPolicy', env, verbose=1, learning_starts=0,
    ...
    hlp.test_agent(
        env, agent, n_epochs=200, fig_title='Agent test before training')
    ...
    hlp.test_agent(
        env, agent, n_epochs=500, fig_title='Agent test after training')

    # Calculate performance metrics
    metrics = hlp.calculate_performance_metrics(env)
