...
class QFunction(object):
    def __init__(self, sampler_type: str, state_space: gym.spaces.Space,
                 ...
                 n_meas_for_average: int, n_rows: int, n_columns: int,
        ...
        :param n_rows: number of unit cells along x-axis of the Chimera graph.
        :param n_columns: number of unit cells along y-axis of the Chimera
        graph.
    ...
    def update_weights(
            ...
            learning_rate: float, grad_clip: float = 10.) -> None:
