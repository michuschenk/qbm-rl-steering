...
def hack_the_env(env: gym.Env) -> gym.Env:
    # TODO: something is not right with the normalization. How do they do it properly in SB3 / 
gym?
    #  The reason is that some of the bounds are +/- np.inf which my code does not like so 
much ...
    # For now we hack the lows and highs of the default observation_space, but keep in mind. 
Might cause
...
def get_params() -> Tuple[Dict, Dict, Dict]:
    ...
    kwargs_anneal = {
        ...
        'kwargs_qpu': {
            'token': "DEV-0e07ab13594ade21154e9244ec6c6069198a5260",  # 
"DEV-66ff199bc69a2ea5bb4223259859867c616de277",
...
def evaluate(agent: QBMQ, n_evals: int = 10) -> Tuple[np.ndarray, np.ndarray, np.ndarray, 
np.ndarray]:
    """
